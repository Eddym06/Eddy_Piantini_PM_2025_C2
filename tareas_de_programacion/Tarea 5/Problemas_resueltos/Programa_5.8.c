...
const int TAM = 100; void Imprime(int, int);
void Primo(int, int *);
void main(void)
{
int P[TAM] = {1,2};
int FLA, J = 2, PRI = 3; while (J <= TAM)
{
FLA = 1; Primo(PRI, &FLA); ➥primo. */
if (FLA) {
P[J] = PRI;
J++; }
PRI += 2; }
...
/* Se llama a la función que determina si PRI es /* Si FLA es 1, entonces PRI es primo. */
