#include <stdio.h>
/* Ordenación por selección directa. */ const int MAX = 100;
...
while (TAM>MAX 􏰁 TAM<1); /* Se verifica que el tamaño del arreglo sea
➥correcto. */
Lectura(VEC, TAM); Ordena(VEC, TAM); Imprime(VEC, TAM); }
