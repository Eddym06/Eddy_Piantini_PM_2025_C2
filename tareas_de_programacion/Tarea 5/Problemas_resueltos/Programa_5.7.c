...
void Lectura(int *, int); /* Prototipos de funciones. */ void Imprime(int *, int);
...
while (TAM > 100 􏰁 TAM < 1);
Lectura(ARRE, TAM);
Elimina(ARRE, &TAM);
/* Observa que el tamaño del arreglo se pasa por referencia.*/ Imprime(ARRE, TAM);
}
