...
c = 3;
d = 4;
printf(“\n%d %d %d %d”, a, b, c, d); funcion1 (&b, &c);
/* Nota que a es una variable local. */
/* Se asigna un valor a la variable local a. */
/* Se asignan valores a las variables globales b, c y d. */
printf(“\n%d %d %d %d”, a, b, c, d); a = funcion2(c, &d);
printf(“\n%d %d %d %d”, a, b, c, d); }
void funcion1(int *b, int *c) {
int d;
a = 5;
/* Observa que se hace referencia a la variable global a. */ /* Nota que se hace referencia a la variable local d. */
d = 3;
(*b)++;
(*c) += 2;
printf(“\n%d %d %d %d”, a, *b, *c, d); }
