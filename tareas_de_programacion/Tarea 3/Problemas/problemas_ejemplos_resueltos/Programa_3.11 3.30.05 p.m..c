...
void main(void)
{
    ...
    while (CAL != -1)
    {
        if (CAL < 4)
            R1++;
        else if (CAL < 6) // Corrected: use else if for chained conditions
            R2++;
        else if (CAL < 8) // Corrected: use else if
            R3++;
        else if (CAL < 9) // Corrected: use else if
            R4++;
        else
            R5++;
    ...
    printf("\n6..7.99 = %d", R3);
    printf("\n8..8.99 = %d", R4);
    printf("\n9..10   = %d", R5); // Added spaces for alignment
}