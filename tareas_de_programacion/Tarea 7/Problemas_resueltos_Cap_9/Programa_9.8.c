...
void escribe(FILE *ap) /* Esta función sirve para leer los datos de los alumnos utilizando una ➥estructura tipo alumno, que se almacenará posteriormente en un archivo. */
{
alumno alu;
int i = 0, r;
