...
const int MES = 12; const int DEP = 3; const int AÑO = 8;
void Lectura(float [MES][DEP][AÑO], int, int, int); void Funcion1(float [MES][DEP][AÑO], int, int, int); void Funcion2(float [MES][DEP][AÑO], int, int, int); ➥de funciones. */
/* Prototipos
void Funcion3(float [MES][DEP][AÑO], int, int, int);
void main(void)
{
float PRO[MES][DEP][AÑO]; Lectura(PRO, MES, DEP, AÑO); Funcion1(PRO, MES, DEP, 2); Funcion2(PRO, MES, DEP, AÑO); Funcion3(PRO, MES, DEP, AÑO); }
...
{
printf(”\n\nDepartamento con mayores ventas en el último año: Licra”); printf(” Ventas:%.2f”, SUM3);
}
else
if (SUM2 > SUM3) {
printf(”\n\nDepartamento con mayores ventas en el último año: Lanas”); printf(” Ventas:%.2f”, SUM2);
}
else
{
} }
